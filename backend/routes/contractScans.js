...
- Имената и адресите се преписват ТОЧНО както са изписани в документа — БЕЗ транслитерация и превод (латиница остава латиница, кирилица остава кирилица). Без кавички.`;
