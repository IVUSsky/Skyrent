...
function buildFields(contract, issuer) {
  ...
  return {
    ...
    'АБОНАТ_ТОК':             contract.абонат_ток  || prop?.['абонат_ток']  || '..................',
    'АБОНАТ_ВОДА':            contract.абонат_вода || prop?.['абонат_вода'] || '..................',
    'АБОНАТ_ТЕЦ':             contract.абонат_тец  || prop?.['абонат_тец']  || '..................',
    'АБОНАТ_ВХОД':            contract.абонат_вход || prop?.['абонат_вход'] || '..................',
