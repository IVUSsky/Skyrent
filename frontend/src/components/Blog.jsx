  ...
  return (
    <div style={{ minHeight: '100vh', background: INK, color: CREAM, fontFamily: "'Manrope', sans-serif" }}>
      ...
      <article style={{ maxWidth: 760, margin: '0 auto', padding: '48px clamp(20px, 5vw, 32px) 80px', fontSize: 17 }}>
        ...
        <H2>Кои сме ние</H2>
        <P>Skyrent е създаден от Скай Кепитъл ООД — наемодатели, които управляват собствен портфейл от имоти в няколко големи града, основно в София. Софтуерът не е писан в офис по презумпции — всяка функция идва от реален проблем, който сами сме имали.</P>
