...
const FAQ = [
  ['Колко струва програмата за управление на имоти?', 'Skyrent е безплатен завинаги за до 5 имота (план Basic, без банкова карта). Pro планът е 24 €/месец с неограничени имоти, банков импорт, онлайн плащания и портал за наематели. Agency планът за агенции е 49 €/месец.'],
    ...
    <div style={{ minHeight: '100vh', background: INK, color: CREAM, fontFamily: "'Manrope', sans-serif" }}>
      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '48px clamp(20px, 5vw, 32px) 80px', fontSize: 17 }}>
        ...
        <div style={{ marginTop: 40, padding: '28px 26px', borderRadius: 16, border: `1px solid rgba(224,189,110,.35)`, background: 'rgba(224,189,110,.06)', textAlign: 'center' }}>
          ...
          <div style={{ color: MUTED, marginBottom: 18 }}>Регистрация за 2 минути. Безплатно до 5 имота — без банкова карта, без срок.</div>
